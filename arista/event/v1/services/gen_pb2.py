...
_EVENTSTREAMREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='returned_fields', full_name='arista.event.v1.EventStreamRequest.returned_fields', index=2,
...
_EVENTANNOTATIONCONFIGSTREAMREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='returned_fields', full_name='arista.event.v1.EventAnnotationConfigStreamRequest.returned_fields', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EVENTSTREAMREQUEST.fields_by_name['returned_fields'].message_type = arista_dot_event_dot_v1_dot_event__pb2._EVENT
...
_EVENTANNOTATIONCONFIGSTREAMREQUEST.fields_by_name['returned_fields'].message_type = arista_dot_event_dot_v1_dot_event__pb2._EVENTANNOTATIONCONFIG
...
_EVENTRESOURCE = _descriptor.ServiceDescriptor(
  name='EventResource',
  full_name='arista.event.v1.EventResource',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetOne',
    full_name='arista.event.v1.EventResource.GetOne',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='GetAll',
    full_name='arista.event.v1.EventResource.GetAll',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='Subscribe',
    full_name='arista.event.v1.EventResource.Subscribe',
    index=2,
    containing_service=None,
    input_type=_EVENTSTREAMREQUEST,
    output_type=_EVENTSTREAMRESPONSE,
...
_sym_db.RegisterServiceDescriptor(_EVENTRESOURCE)

DESCRIPTOR.services_by_name['EventResource'] = _EVENTRESOURCE


_EVENTANNOTATIONCONFIGRESOURCE = _descriptor.ServiceDescriptor(
  name='EventAnnotationConfigResource',
  full_name='arista.event.v1.EventAnnotationConfigResource',
  file=DESCRIPTOR,
  index=1,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetOne',
    full_name='arista.event.v1.EventAnnotationConfigResource.GetOne',
    index=0,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetAll',
    full_name='arista.event.v1.EventAnnotationConfigResource.GetAll',
    index=1,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='Subscribe',
    full_name='arista.event.v1.EventAnnotationConfigResource.Subscribe',
    index=2,
    containing_service=None,
    input_type=_EVENTANNOTATIONCONFIGSTREAMREQUEST,
    output_type=_EVENTANNOTATIONCONFIGSTREAMRESPONSE,
  ...
  _descriptor.MethodDescriptor(
    name='Set',
    full_name='arista.event.v1.EventAnnotationConfigResource.Set',
    index=3,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='Delete',
    full_name='arista.event.v1.EventAnnotationConfigResource.Delete',
    index=4,
    containing_service=None,
...
_sym_db.RegisterServiceDescriptor(_EVENTANNOTATIONCONFIGRESOURCE)

DESCRIPTOR.services_by_name['EventAnnotationConfigResource'] = _EVENTANNOTATIONCONFIGRESOURCE
