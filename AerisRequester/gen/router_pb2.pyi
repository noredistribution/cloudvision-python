...
class GetRequest(google___protobuf___message___Message):
    ...
    wildcard_expand_type = ... # type: PathWildCardExpandType
    ...
    def __init__(self,
        *,
        ...
        sharded_sub : typing___Optional[sharding_pb2___Sharding] = None,
        wildcard_expand_type : typing___Optional[PathWildCardExpandType] = None,
        ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"sharded_sub"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"end",u"exact_range",u"query",u"sharded_sub",u"start",u"versions",u"wildcard_expand_type"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"sharded_sub",b"sharded_sub"]) -> builtin___bool: ...
...
class GetAndSubscribeRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"sharded_sub"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"exact_range",u"query",u"sharded_sub",u"start",u"versions"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"sharded_sub",b"sharded_sub"]) -> builtin___bool: ...
...
class SearchRequest(google___protobuf___message___Message):
    ...
    @property
    def key_filters(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Filter]: ...

    @property
    def value_filters(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Filter]: ...
    ...
    def __init__(self,
        *,
        ...
        key_filters : typing___Optional[typing___Iterable[Filter]] = None,
        value_filters : typing___Optional[typing___Iterable[Filter]] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"count_only",u"end",u"key_filters",u"query",u"search",u"search_type",u"start",u"value_filters"]) -> None: ...
    else:
...
class Filter(google___protobuf___message___Message):
    ...
    class Value(google___protobuf___message___Message):
        ...
        @property
        def comp(self) -> Filter.ComponentValue: ...

        @property
        def multi(self) -> Filter.MultiValue: ...
        ...
        def __init__(self,
            *,
            ...
            comp : typing___Optional[Filter.ComponentValue] = None,
            multi : typing___Optional[Filter.MultiValue] = None,
            ) -> None: ...
        @classmethod
        ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def HasField(self, field_name: typing_extensions___Literal[u"b",u"comp",u"float",u"int",u"ip",u"kind",u"mac",u"multi",u"str",u"uint"]) -> builtin___bool: ...
            def ClearField(self, field_name: typing_extensions___Literal[u"b",u"comp",u"float",u"int",u"ip",u"kind",u"mac",u"multi",u"str",u"uint"]) -> None: ...
        else:
    ...
    class MultiValue(google___protobuf___message___Message):
        ...
        @property
        def values(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[Filter.Value]: ...

        def __init__(self,
            *,
            values : typing___Optional[typing___Iterable[Filter.Value]] = None,
            ) -> None: ...
        @classmethod
    ...
    op = ... # type: Filter.Operator

    @property
    def value(self) -> Filter.Value: ...

    def __init__(self,
        *,
        field : typing___Optional[typing___Text] = None,
        op : typing___Optional[Filter.Operator] = None,
        value : typing___Optional[Filter.Value] = None,
        ) -> None: ...
    @classmethod
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"field",u"op",u"value"]) -> None: ...
    else:
...
class SetPermissionRequest(google___protobuf___message___Message):
    ...
    class PathPerm(google___protobuf___message___Message):
        ...
        newPerm = ... # type: SetPermissionRequest.PathPerm.Perm
        currentPerm = ... # type: SetPermissionRequest.PathPerm.Perm
        ...
        def __init__(self,
            *,
            path : typing___Optional[Path] = None,
            newPerm : typing___Optional[SetPermissionRequest.PathPerm.Perm] = None,
            currentPerm : typing___Optional[SetPermissionRequest.PathPerm.Perm] = None,
        ...
        if sys.version_info >= (3,):
            ...
            def ClearField(self, field_name: typing_extensions___Literal[u"currentPerm",u"exactMatch",u"newPerm",u"path"]) -> None: ...
        else:
    ...
    type = ... # type: SetPermissionRequest.Type
    ...
    @property
    def pathPerms(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[SetPermissionRequest.PathPerm]: ...

    def __init__(self,
        *,
        type : typing___Optional[SetPermissionRequest.Type] = None,
        dataset : typing___Optional[notification_pb2___Dataset] = None,
        other : typing___Optional[notification_pb2___Dataset] = None,
        pathPerms : typing___Optional[typing___Iterable[SetPermissionRequest.PathPerm]] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"dataset",u"other"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset",u"other",u"pathPerms",u"type"]) -> None: ...
    else:
...
class PermissionSet(google___protobuf___message___Message):
    ...
    @property
    def permissions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[SetPermissionRequest]: ...

    def __init__(self,
        *,
        permissions : typing___Optional[typing___Iterable[SetPermissionRequest]] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"permissions"]) -> None: ...
    else:
...
class ClusterDescription(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"clusterName",u"epoch",u"timestamp"]) -> None: ...
    else:
...
class SetPasswordRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"dataset"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"dataset",u"password"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"dataset",b"dataset"]) -> builtin___bool: ...
...
class CreateSessionResponse(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"expiry",u"jwtToken"]) -> None: ...
    else:
